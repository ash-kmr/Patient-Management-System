...
function getTimeSlot(x){
        ...
        document.getElementById("Date_Appointment").value = query;
        /*
        var url = "";
        //alert(query);
                        ...
                        var html = "";
                                ...
                                html += "<div class='col-sm-2'>";                                         
                                   ...
                                   html += "<div class = 'col-sm-4'>";
                                    html += "<input style='width: 20px; height: 20px' value = '1' class= 'Time_Slots' onchange='changeInputValues("+date+")' name = 'Slots' type = 'checkbox' id = '" + key + "'></div>";
