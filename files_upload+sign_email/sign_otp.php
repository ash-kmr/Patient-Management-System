					...
					if($_POST['OTP'])
						{
							...
							$sql = "select otp, date, count(*) as total from verify_email where otp = '".$otp."'";
							...
							if($row['total'])
								{
									...
									if($time>300)
										{
										echo "<script>alert('OTP expired ,please generate new OTP and try again'); window.location.href='mainheader.php'; </script>";
										}				
									else
										{
											session_start();
  ...
  <div class="form">
    <div id="signup">   
      ...
      <div class="field-wrap">
        ...
        <input type="number" name = "otp" required autocomplete="off"/>
      </div>
